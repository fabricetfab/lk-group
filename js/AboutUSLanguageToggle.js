...
const translations = {
  en: {
    ...
    step1: 'Businesses contact us with their staffing requirements.',
    step2: 'We match the best-suited candidates with the job requirements and facilitate the placement process.',
    step3: 'We source and screen qualified and trained candidates from our pool of temporary workers.',
    step4: 'We provide ongoing support and assistance to ensure a successful temporary work arrangement.',
    footerH4: "LK GROUP",
  ...
  fr: {
    ...
    step1: 'Les entreprises nous contactent avec leurs besoins en matière de recrutement.',
    step2: 'Nous associons les candidats les mieux adaptés aux exigences du poste et facilitons le processus de placement.',
    step3: 'Nous sélectionnons et évaluons des candidats qualifiés et formés à partir de notre vivier de travailleurs temporaires.',
    step4: 'Nous fournissons un soutien continu et de l\'assistance pour garantir la réussite de l\'arrangement de travail temporaire.',
    footerH4: "LK GROUP",
